...
`hlds` user is created with account locked and password disabled, you need to use `sudo su - hlds` if you plan to do further server configuration in `/home/hlds/.steam` directory.
